import datetime
#from commtrack.models import Status
...
class TrackResource(models.Model):
    tracked_resource = models.ForeignKey(Resource)
    ...
    def __unicode__(self):
        return '%s : %s' % (self.tracked_resource, self.date_tracked)
